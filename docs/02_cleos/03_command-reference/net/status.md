...
**Note:** The `last_handshake` field contains the chain state of the specified peer as of the last handshake message with the node. For more information read the [Handshake Message](/general_info/protocol-guides/network_peer_protocol#421-handshake-message) in the *Network Peer Protocol* document.
